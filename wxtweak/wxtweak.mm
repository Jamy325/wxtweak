...
{
    KeychainItemWrapper *wrapper=[[KeychainItemWrapper alloc] initWithIdentifier:@"com.tencent.xin.wxtweak" accessGroup:nil];
...
#line 133 "/Users/jamy/works/wxtweak/wxtweak/wxtweak.xm"
...
static NSString * _logos_method$_ungrouped$NSBundle$bundleIdentifier(_LOGOS_SELF_TYPE_NORMAL NSBundle* _LOGOS_SELF_CONST self, SEL _cmd) {
    ...
    NSString* old = _logos_orig$_ungrouped$NSBundle$bundleIdentifier(self, _cmd);
